...
Follow the steps for a language server to get it up and running. When a language server is running in a file, an indicator will appear in the status bar:
